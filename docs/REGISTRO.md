...
| `reports/prediction_t20_2026-09-26/` | attuale | — | Previsione del t20 (t19 + modulo cis) registrata **prima** della generazione, il 25 settembre alle 22:04 UTC: banda +0,115…+0,17, regola di lettura contro il t19 (±0,005, lettura di non inferiorità nel caso intermedio) | — |
| `reports/trial_2026-09-26/` | attuale | — | Testi del t20 scritti prima dell'invio, dopo la registrazione e durante la generazione. t20 generato e impacchettato il 25 fra le 22:05 e le 22:55Z (`t20_*`): convalida del contenitore superata, payload identico all'input, archivio sha256 `e80e135a…a16b`. L'invio aspetta il via del proprietario | — |
