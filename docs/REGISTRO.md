...
|---|---|---|---|---|
| `reports/multisource_2026-09-22/` | attuale | — | Script 98. `PRIMA_DEI_RISULTATI.md` fissa la regola della ricetta t08 (sorgenti K562 + CD4, criterio per γ, pesi e ampiezza da `shared_signal`, generatore di trial-01 invariato) **prima** che esista un numero su CD4. I rapporti di trasferimento che seguono sono proxy nello spazio degli effetti, non punteggi VCC | — |
