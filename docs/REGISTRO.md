...
| `reports/bersagli_nuovi_2026-09-26/` | attuale | — | I 300 del pannello trattati da bersagli nuovi, esclusi da ogni addestramento: il modello lineare con embedding dei geni non discrimina nemmeno in campione (r2); cis da solo 0,555–0,579 di PDS proxy; 0,1 × STRING + cis +0,009…+0,035 (r3); stesso bersaglio misurato in K562 0,711–0,755. r1 confronta bracci con e senza la risposta comune: i confronti puliti sono in r3. Proxy, non punteggi VCC | — |
...
| `reports/rete_2026-09-26/` | attuale | — | Lisciamento del t20 con la risposta media dei partner fisici STRING (K562, bersaglio escluso) sui bersagli misurati: +0,0002…+0,003 di PDS proxy, solo CD4 a λ 0,1 con intervallo sopra zero; il braccio vero supera sempre il controllo mescolato. Proxy, non punteggi VCC | — |
