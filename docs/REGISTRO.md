...
| `docs/ARCHIVIO.md` | attuale | — | Che cosa la pulizia del 23 settembre ha tolto dall'albero (D-040): 244 file, 50.306 righe, in sei gruppi, con righe e prima riga del docstring di ogni file, il tag `archivio/pre-pulizia-2026-09-23` e il comando di recupero. Il controllo documentale accetta i percorsi elencati lì, e solo quelli. Dal 24 settembre ha una seconda sezione, la pulizia di D-043, con il tag `archivio/pre-pulizia-2026-09-24` | — |
