...
| `reports/trial_2026-09-23/` | attuale | — | Il t10 (il t08 senza CD4): testi della sottomissione scritti prima dell'invio; poi manifesti e output verbatim di `vcc` | — |
...
| `reports/prediction_t10_2026-09-23/` | attuale | — | Previsione del t10 (il t08 senza CD4) registrata **prima** della generazione: banda +0,040…+0,060 e regola di lettura fissata prima (≤ 0,050: CD4 porta almeno due terzi del guadagno del t08; ≥ 0,056: il guadagno viene soprattutto da stimatore e centratura) | — |
