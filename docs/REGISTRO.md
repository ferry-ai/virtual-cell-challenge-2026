...
| `docs/piani/` | attuale | — | Schede operative modificabili e guida: R-DATI, R-MODELLI, R-SWITCH, S-INVII. Nessuna chiusa all'introduzione; assegnazioni pregresse da verificare. Le priorità promettenti sono ipotesi, non risultati | — |
